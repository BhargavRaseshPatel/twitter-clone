...
const TabsLayout = () => {
    ...
    return (
        <Tabs screenOptions={{title: "", tabBarActiveTintColor: "#1DA1F2", tabBarInactiveTintColor: "#657786", headerShown: false}}>
            ...
            <Tabs.Screen name='message' options={{ tabBarIcon: ({ color, size }) => <Feather name="mail" size={size} color={color} /> }} />
