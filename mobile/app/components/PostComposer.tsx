    ...
    return (
        <View className='border-b border-gray-100 p-4 bg-white'>
            <View className='flex-row'>
                ...
                <View>
                    <TextInput className='text-gray-900 text-lg' placeholder="What's happening"
                        placeholderTextColor={"#657786"} multiline value={content} onChangeText={setContent} maxLength={280} />
                </View>
            </View>
